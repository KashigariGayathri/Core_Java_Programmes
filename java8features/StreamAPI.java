...
public class StreamAPI {
	...
	public static void main(String[] args) {
		...
		List<Employeees> empList = new ArrayList<Employeees>();
		...
		Optional<Employeees> youngestEmp = empList.stream().filter(e -> e.getGender().equals("F")) // Filter by gender
																									// (female)
		...
		empList.stream() // Create a stream of employees
				...
				.forEach(e -> System.out.println("Employees staying in Blore:: " + e.getName())); // Print the names of
																									// employees
